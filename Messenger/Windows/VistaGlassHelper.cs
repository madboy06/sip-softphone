...
namespace Windows.Helpers
{
    public class VistaGlass
    {
        ...
        public static Margins GetDpiAdjustedMargins(IntPtr windowHandle, int left, int right, int top, int bottom)
        {
            ...
            // Set Margins
            VistaGlass.Margins margins = new VistaGlass.Margins();
        ...
        public static void ExtendGlass(Window win, int left, int right, int top, int bottom)
        {
            ...
            VistaGlass.Margins margins =
                VistaGlass.GetDpiAdjustedMargins(windowHandle, left, right, top, bottom);

            int returnVal = VistaGlass.DwmExtendFrameIntoClientArea(mainWindowSrc.Handle, ref margins);
